...
@export var udp_trackers := {
	"tracker.torrust-demo.com": 6969,
	...
	"leet-tracker.moe": 1337,
	"isk.richardsw.club": 6969,
	"hificode.in": 6969,
	"discord.heihachi.pw": 6969,
	"udp.tracker.projectk.org": 23333,
	"ttk2.nbaonlineservice.com": 6969,
	"tracker2.dler.org": 80,
	"tracker.zupix.online": 6969,
	"tracker.valete.tf": 9999,
	"tracker.therarbg.to": 6969,
	"tracker.theoks.net": 6969,
	"tracker.srv00.com": 6969,
	"tracker.skillindia.site": 6969,
	"tracker.plx.im": 6969,
	"tracker.kmzs123.cn": 17272,
	"tracker.hifitechindia.com": 6969,
	"tracker.hifimarket.in": 2710,
	"tracker.healthcareindia.store": 1337,
	"tracker.gmi.gd": 6969,
	"tracker.gigantino.net": 6969,
	"tracker.fnix.net": 6969,
	"tracker.filemail.com": 6969,
	"tracker.dler.org": 6969,
	"tracker.bitcoinindia.space": 6969,
	"tracker-udp.gbitt.info": 80,
	"tr4ck3r.duckdns.org": 6969,
	"t.overflow.biz": 6969,
	...
	"opentracker.io": 6969,
	"open.dstud.io": 6969,
	"martin-gebhardt.eu": 25,
	"ipv4announce.sktorrent.eu": 6969,
	"evan.im": 6969,
	"d40969.acod.regrucolo.ru": 6969,
	"bittorrent-tracker.e-n-c-r-y-p-t.net": 1337,
	"bandito.byterunner.io": 6969,
	"6ahddutb1ucc3cp.ru": 6969,
	"1c.premierzal.ru": 6969,
	"tracker.yume-hatsuyuki.moe": 6969,
	"ipv4.rer.lol": 2710,
	"concen.org": 6969,
	"bt.rer.lol": 6969
}
...
func _ready():
	...
	#return
	randomize()
	var keys := udp_trackers.keys()
	var random_key: String = keys[randi() % keys.size()]
	prints("tracker " ,random_key , " port : ",udp_trackers[random_key] )
	#"host": random_key,
	#"port": udp_trackers[random_key]
	#
	if udplink == "":
		udplink = random_key
		portudp = udp_trackers[random_key]
...
func prueba():
	...
	for i in keys:
		...
		random_key = i
		#rang =+ 1
		prints("tracker " ,random_key , " port : ",udp_trackers[i] )
		#"host": random_key,
		#"port": udp_trackers[random_key]
		#
		if udplink == "":
...
#
	...
	var info_hash := hex_to_bytes("9bccd461daf03b10a7ad6ce033435f88c30eb607")  # Ubuntu ISO
#18bc69892a5a546143ade969e3858d6b41089b8d   # 20 bytes
#"d2474e86c95b19b8bcfdb92bc12c9d44667cfa36"

	'''
	Valor	Evento	Significado técnico
	0	none	Estado normal, sin cambio
	1	completed	Terminaste de descargar el archivo ✅
	2	started	Comenzaste a descargar o compartir
	3	stopped	Cerraste el cliente o dejaste de compartir


	downloaded	500_000	Ya descargaste la mitad del archivo
	left	500_000	Te falta la otra mitad
	uploaded	10_000_000	Ya compartiste 10 MB con otros peers


	var file_size := 1_000_000  # 1 MB en bytes
	var downloaded := to_bytes(file_size / 2, 8)  # 500_000 bytes descargados
	var left := to_bytes(file_size / 2, 8)        # 500_000 bytes restantes
	var uploaded := to_bytes(10_000_000, 8)       # 10 MB subidos
	'''
