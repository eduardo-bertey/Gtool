...
pub struct MetadataHandler {
    pub metadata_piece_download_status: Vec<(bool, PeerAddr, SystemTime)>, // downloaded, peer addr we requested piece to, request time
    pub raw_metadata: Option<Vec<u8>>,
    pub raw_metadata_size: Option<i64>,
}
