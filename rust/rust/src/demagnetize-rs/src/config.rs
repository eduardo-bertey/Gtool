...
pub struct GeneralConfig {
    ...
    pub batch_jobs: NonZeroUsize,

    pub encrypt: CryptoPreference,
}
...
pub struct PeersConfig {
    ...
    #[serde(deserialize_with = "deserialize_seconds")]
    pub dh_exchange_timeout: Duration,
}
...
pub struct DhtConfig {
    ...
    pub bootstrap_nodes: mitsein::vec1::Vec1<InetAddr>,
...
impl LocalPort {
    pub fn generate<R: Rng>(&self, mut rng: R) -> u16 {
        match *self {
            LocalPort::Constant(p) => p,
            LocalPort::Range { low, high } => rng.gen_range(low..=high),
        }
    }
}
...
impl CryptoPreference {
    pub fn get_tracker_crypto(&self) -> TrackerCrypto {
        match self {
    ...
    pub fn get_crypto_mode(&self, requires_crypto: bool) -> Option<CryptoMode> {
